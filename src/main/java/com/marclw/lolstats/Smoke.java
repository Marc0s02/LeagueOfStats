 ...
 *
 * matchId looks like "EUW1_1234567890" (platform prefix + underscore +
 * numeric id) - grab one from your own match history via the League
 * client, or from fetchMatchIdsForPuuid if you've got a puuid handy.
 *
 * regionalBaseUrl defaults to https://europe.api.riotgames.com - change
 * it if your matches are on americas/asia/sea routing instead. This is
 * the REGIONAL host (europe/americas/asia/sea), not the platform host
 * (euw1/na1/etc) - see RiotMatchClient's class doc for why those differ.
 */
